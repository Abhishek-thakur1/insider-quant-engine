...
This file is deliberately thin and is identical in substance to `CLAUDE.md`. Do not duplicate
content from `AGENTS.md` into either — two copies of a fact become one stale fact.
